...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'projectsSwampifyFloor', source: './models/projects/swampify/floorTexture.webp', type: 'texture' },
            { name: 'projectsPartifyFloor', source: './models/projects/partify/floorTexture.webp', type: 'texture' },
